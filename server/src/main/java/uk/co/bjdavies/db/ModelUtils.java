...
import uk.co.bjdavies.db.Table.ModelBlueprint;
import uk.co.bjdavies.db.Table.TableBuilder;
...
public class ModelUtils {
    ...
    public static <T extends Model> List<T> all(Class<T> clazz) {
        return getQueryBuilder(clazz).get();
    }
    ...
    public static <T extends Model> IModelBuilder<T> where(Class<T> clazz, String key, Comparator comparator, Object value) {
